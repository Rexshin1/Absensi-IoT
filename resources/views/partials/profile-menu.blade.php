<div class="relative" @click.outside="profileOpen = false">
    ...
    <div x-cloak x-show="profileOpen" x-transition class="absolute right-0 z-50 mt-3 w-44 rounded-sm bg-background p-2 shadow-md dark:bg-darkgray">
        ...
        <a href="#" class="flex items-center gap-3 px-3 py-2 hover:bg-lightprimary hover:text-primary"><x-icon name="solar:letter-linear" size="20" />My Account</a>
        <a href="#" class="flex items-center gap-3 px-3 py-2 hover:bg-lightprimary hover:text-primary"><x-icon name="solar:checklist-linear" size="20" />My Task</a>
